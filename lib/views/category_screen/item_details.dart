            ...
            Obx(
                    ()=> IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: controller.isFav.value ? blackColor : darkFontGrey,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      //  rating
                        ...
                        10.heightBox,
                        "${data['p_price']}".numCurrency.text.color(blackColor).fontFamily(bold).size(18).make(),
                            ...
                            //   total row
                              Row(
                                children: [
                                  ...
                                  "${controller.totalPrice.value}".numCurrency.text.color(blackColor).size(16).fontFamily(bold).make(),
                      ...
                      //  products you may also like sectin
                        20.heightBox,
                        productsyoumaylike.text.fontFamily(bold).size(16).color(darkFontGrey).make(),
                        10.heightBox,
                        //same as the code in home_screen.dart #featured products
                            ...
                            List.generate(
                                6,
                                  ...
                                  children: [
                                    ...
                                    10.heightBox,
                                    "\$600".text.color(blackColor).fontFamily(bold).size(16).make(),
                                  ],
